...
<body>
    <div id="container">
        ...
        <nav class="row">
            ...
            <div class="col-md-10 col-sm-10 col-12">
                <ul>
                    ...
                    <li><a href="" class="left active">Mijn werk</a></li>
        ...
        <div class="row information">
            ...
            <div class="col-md-4">
                <h2>Project 1</h2>
                <p>Kleine omschrijving van project 1, Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim.</p>
                <a href="project.php" style="color:#ffe900;">Meer over te weten komen</a>
            </div>
            <div class="col-md-2"></div>
        </div>
        ...
        <div class="row information">
            ...
            <div class="col-md-4">
                <h2>Project 2</h2>
                <p>Kleine omschrijving van project 2, Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim.</p>
                <a href="project.php" style="color:#ffe900;">Meer over te weten komen</a>
            </div>
            <div class="col-md-2"></div>
        </div>
